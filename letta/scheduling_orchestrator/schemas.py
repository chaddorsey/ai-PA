...
class UserDisplay(BaseModel):
    ...
    verbatim_user_output: Optional[str] = Field(default=None, description="Verbatim user-facing formatted text with grouped proposals by day, wrapped in [VERBATIM_USER_OUTPUT] tags")
