...
if DSPY_AVAILABLE:
    class ExtractSchedulingRequest(dspy.Signature):
        ...
        """
        utterance: str = dspy.InputField(desc="Natural language scheduling request. When the utterance says 'me' or 'I', it refers to the requester (first participant in context). When the utterance says 'with X and Y', the requester should be included in the participants list.")
