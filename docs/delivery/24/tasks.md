...
| :------ | :----------------------------------------------- | :------- | :----------------------------------------------- |
| 24-1 | [Define daily briefing tool interface & schemas](./24-1.md) | Proposed | Specify the Letta tool `generate_daily_briefing` with typed args/docstring or Pydantic models. Define input/output schemas. |
