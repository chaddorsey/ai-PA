...
def omnifocus_perspective(action: str, params: Optional[str] = None, fields: Optional[str] = None) -> Dict[str, Any]:
    """
    Manage OmniFocus perspectives. Run omnifocus-cli schema perspective.<action> to discover params.

    Args:
        action: One of: list, get, switch (REQUIRED)
    ...
    try:
        cli_args = ["omnifocus-cli", "perspective", action]
        if params:
