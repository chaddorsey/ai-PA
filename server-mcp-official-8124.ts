            ...
            switch (type) {
              case "tasks":
                ...
                if (typeof filters === 'object' && filters !== null && 'search' in filters) {
                  commandArgs.search = (filters as any).search;
                }
                break;
              case "remaining":
              ...
              case "task":
                ...
                if (typeof filters === 'object' && filters !== null && 'taskId' in filters) {
                  commandArgs.taskId = (filters as any).taskId;
                }
                break;
              case "projects":
              ...
              case "project":
                ...
                if (typeof filters === 'object' && filters !== null && 'projectId' in filters) {
                  commandArgs.projectId = (filters as any).projectId;
                }
                break;
              case "folders":
                command = "listFolders";
              ...
              case "folder":
                ...
                if (typeof filters === 'object' && filters !== null && 'folderId' in filters) {
                  commandArgs.folderId = (filters as any).folderId;
                }
                break;
              case "tags":
                command = "listTags";
              ...
              case "tag":
                ...
                if (typeof filters === 'object' && filters !== null && 'tagId' in filters) {
                  commandArgs.tagId = (filters as any).tagId;
                }
                break;
              case "perspectives":
              ...
              case "perspective":
                ...
                if (typeof filters === 'object' && filters !== null && 'perspectiveId' in filters) {
                  commandArgs.perspectiveId = (filters as any).perspectiveId;
                }
                break;
              case "inbox":
                command = "listInbox";
