...
class MCPHttpBridge {
  ...
  private startMCPServer() {
    ...
    this.mcpProcess.stdout.on('data', (data: string) => {
  ...
  private handleMCPOutput(data: string) {
    this.buffer += data;
  ...
  private handleMCPResponse(response: MCPResponse) {
    if (response.error) {
  ...
  private sendToMCP(request: MCPRequest, res: http.ServerResponse) {
